...
/**
 * @brief classe abstrata com propriedades comuns para luzes
 */
class Light{
  constructor(){
...
/**
 * @brief Câmera com projeção ortográfica/arquitetônica
 *
 * @class
 */
